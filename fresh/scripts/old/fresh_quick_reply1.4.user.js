...
var vbcmds = new Array("namedlink('URL')", "return vbcode('IMG', 'http://')", "return vbcode('PHP', '')", "return vbcode('YOUTUBE', '', 0)", "return vbcode('SPOILER', '')", "return vbcode('TEX', '')", "return vbcode('SMILEYSIGN', '')", "open_smilie_window(smiliewindow_x, smiliewindow_y, 0, '86')");
...
controlbar.insertCell(i+1).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[0]+'"><img src="http://static.fresh.co.il/images/vBulletin/editor/createlink.gif" alt="הכנס תמונה" width="21" height="20" border="0" /></a></div>';
controlbar.insertCell(i+2).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[1]+'"><img src="http://static.fresh.co.il/images/vBulletin/editor/insertimage.gif" alt="הכנס תמונה" width="21" height="20" border="0" /></a></div>';
controlbar.insertCell(i+3).innerHTML='<img src="http://static.fresh.co.il/images/vBulletin/editor/separator.gif" alt="" width="6" height="20" />';
controlbar.insertCell(i+4).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[2]+'"><img src="http://static.fresh.co.il/images/vBulletin/editor/php.gif" alt="עטוף תגי [PHP]" width="21" height="20" border="0" /></a></div>';
controlbar.insertCell(i+5).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[3]+'"><img src="http://www.fresh.co.il/vBulletin/images/freshicons/youtube.gif" alt="עטוף תגי [YOUTUBE] סביב טקסט נבחר" title="עטוף תגי [YOUTUBE] סביב טקסט נבחר" width="21" height="20" border="0" /></a></div>';
controlbar.insertCell(i+6).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[4]+'"><img src="http://uploaded.fresh.co.il/2008/02/14/95149184.gif" alt="עטוף תגי [SPOILER] סביב טקסט נבחר" title="עטוף תגי [SPOILER] סביב טקסט נבחר" width="21" height="20" border="0" /></a></div>';
controlbar.insertCell(i+7).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[5]+'"><img src="http://uploaded.fresh.co.il/2008/02/13/13508904.gif" alt="הוספת נוסחא בפורמט TEX" title="הוספת נוסחא בפורמט TEX" width="21" height="20" border="0" /></a></div>';
controlbar.insertCell(i+8).innerHTML='<img src="http://static.fresh.co.il/images/vBulletin/editor/separator.gif" alt="" width="6" height="20" />';
controlbar.insertCell(i+9).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[6]+'"><img src="http://uploaded.fresh.co.il/2008/02/14/86716711.gif" alt="צור סמיילי עם שלט" title="יוצר סמיילי עם טקסט מותאם אישית של שימי" width="21" height="20" border="0" /></a></div>';
//controlbar.insertCell(i+10).innerHTML='<div class="imagebutton"><a onclick="'+vbcmds[7]+'"; return false"><img src="http://uploaded.fresh.co.il/2008/02/13/90378390.gif" alt="פתיחת חלון להוספת סמיילים" title="פתיחת חלון להוספת סמיילים" width="21" height="20" border="0" /></a></div>';
}

// three icons for the spoiler tag button: http://uploaded.fresh.co.il/2008/02/13/41854693.gif, http://uploaded.fresh.co.il/2008/02/13/82408617.gif, http://uploaded.fresh.co.il/2008/02/14/95149184.gif
