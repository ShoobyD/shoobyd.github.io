...
var editormode = (browser == "Netscape") ? unsafeWindow.WYSIWYG : WYSIWYG;
...
var tmpnode_h = document.createElement('div');
var tmpcont_h = document.createTextNode('');
tmpnode_h.setAttribute('id', 'resize_h');
tmpnode_h.setAttribute('class', 'smallfont');
tmpnode_h.style.cssFloat = "right";
tmpnode_h.appendChild(tmpcont_h);
messagebox.appendChild(tmpnode_h);
document.getElementById("resize_h").innerHTML='<a onclick="'+resizecmd[0]+'" href="#">הגדל</a>&nbsp;<a onclick="'+resizecmd[1]+'" href="#">הקטן</a>';
...
document.getElementById("resize_w").innerHTML='<a onclick="'+resizecmd[3]+'" href="#">«</a>&nbsp;<a onclick="'+resizecmd[2]+'" href="#">»</a>';
...
unsafeWindow.alter_box_width = function(boxid, pixelvalue) {
	...
	if (newwidth > 400 && newwidth < screen.width)
	{
